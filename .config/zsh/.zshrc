...
if [ -d "$HOME/.local/bin" ] ;
  ...
  then PATH=$PATH$( find $HOME/.local/bin/ -type d -printf ":%p" )
fi
...
alias nzsh="$EDITOR /home/saikat/.config/zsh/.zshrc"
alias nzshp="$EDITOR /home/saikat/.config/zsh/.zshrc-personal"
